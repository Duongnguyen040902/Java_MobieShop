            ...
            <div class="cart-item">
                <div class="cart-item-infor">
                    <div class="cart-item-img">
                        <img src="<%=path%>/${o.getProduct().getImage()}"/>
                    </div>
                    ...
                    <div class="cart-item-button">
                        <form action="<%=path%>/shopping/buy?tid=${o.getProduct().getProductID()}" method="post">
                            <input id="remove-cart" type="submit" value="Remove" />
                        </form>
                    </div>
                </div>
                <div class="cart-item-function">
                    <a href="<%=path%>/shopping/buy?num=-1&tid=${o.getProduct().getProductID()}">-</a>  
                    <a href="<%=path%>/shopping/buy?num=1&tid=${o.getProduct().getProductID()}">+</a>
