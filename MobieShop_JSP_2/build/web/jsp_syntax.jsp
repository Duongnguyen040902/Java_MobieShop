...
<html>
    ...
    <body>
        ...
        <!--thuộc tính action của form gán địa gửi gửi dữ liệu
        thuộc tính method là phương thức gửi dữ liệu-->
        <%
            <form action="<%=path%>/shopping/order" method="post">
        %>
        
        
        
         <!--Method doGet se luon chay khi goi servlet va khi chay trong the <a> link den 1 url nao day-->
         <!--Method doPost chi chay khi trong file jsp no tham chieu den co form va goi method "post"-->
