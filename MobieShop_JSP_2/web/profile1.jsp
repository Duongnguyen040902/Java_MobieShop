            ...
            <div id="profile-content-order">
                <div>
                    <div class="profile-order-title">
                        ...
                        <div class="profile-order-title-right" style="green">
                            ...
                            <c:if test="${o.getShippedDate()==null}">
                                <c:choose>
                                    <c:when test="${o.getRequiredDate()!=null}">
                                        <td> 
                                            <p onclick="return Check()" style="color: blue">Pending | <a style="color: red" href="<%=path%>/profile1/cancel?oid=${o.getOrderID()}">Cancel</a></p>
                                        </td>
                                    </c:when>
                                    <c:otherwise>
                                        <td> 
                        ...
                        <div class="profile-order-content">
                            <div class="profile-order-content-col1">
                                <a href="detail.html"><img src="<%=path%>/${OrderDAO.getProductImgByProductId(od.getProductID())}" width="100%"/></a>
                            </div>
